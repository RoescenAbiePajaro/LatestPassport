  ...
  return (
    <div className='p-3 md:mx-auto'>
      <div className='flex-wrap flex gap-4 justify-center'>
        <div className='flex flex-col p-3 bg-white dark:bg-gray-800 gap-4 md:w-72 w-full rounded-md shadow-md'>
          <div className='flex justify-between'>
            <div className=''>
              <h3 className='text-gray-500 dark:text-gray-300 text-md uppercase'>Total Users</h3>
        ...
        <div className='flex flex-col p-3 bg-white dark:bg-gray-800 gap-4 md:w-72 w-full rounded-md shadow-md'>
          <div className='flex justify-between'>
            <div className=''>
              <h3 className='text-gray-500 dark:text-gray-300 text-md uppercase'>Total Posts</h3>
      ...
      <div className='flex flex-wrap gap-4 py-3 mx-auto justify-center'>
        <div className='flex flex-col w-full md:w-auto shadow-md p-2 rounded-md bg-white dark:bg-gray-800'>
          ...
          <Table hoverable>
            <Table.Head>
              <Table.HeadCell className='dark:text-gray-200'>User image</Table.HeadCell>
        ...
        <div className='flex flex-col w-full md:w-auto shadow-md p-2 rounded-md bg-white dark:bg-gray-800'>
          ...
          {/* <Table hoverable>
            <Table.Head>
              <Table.HeadCell className='dark:text-gray-200'>Comment content</Table.HeadCell>
              <Table.HeadCell className='dark:text-gray-200'>Likes</Table.HeadCell>
            </Table.Head>
            {comments &&
              comments.map((comment) => (
                <Table.Body key={comment._id} className='divide-y'>
                  <Table.Row className='bg-white dark:bg-gray-800 dark:border-gray-700'>
                    <Table.Cell className='w-96 dark:text-gray-200'>
        ...
        <div className='flex flex-col w-full md:w-auto shadow-md p-2 rounded-md bg-white dark:bg-gray-800'>
          ...
          <Table hoverable>
            <Table.Head>
              <Table.HeadCell className='dark:text-gray-200'>Post image</Table.HeadCell>
              <Table.HeadCell className='dark:text-gray-200'>Post Title</Table.HeadCell>
